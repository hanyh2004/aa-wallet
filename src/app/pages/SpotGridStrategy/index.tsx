...
const SpotGridStrategy = () => {
  ...
  const save = async () => {
    ...
    let key = "strategy_" + selectedRadio;
    ...
    // return;
    if (selectedRadio == "1") {
      localStorage.setItem("strategy_" + selectedRadio,str);
      console.log("xxx");
...
//     // https://smarter-api-at.web3-idea.xyz/at/price/current/${selectedCurrency.toUpperCase()}/USWT/3000`)

  useEffect(() => {
    fetch(`https://smarter-api-at.web3-idea.xyz/api/v1/price/current/simple/0x4B63443E5eeecE233AADEC1359254c5C601fB7f4/0xF981Ac497A0fe7ad2Dd670185c6e7D511Bf36d6d`)
